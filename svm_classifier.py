...
if __name__ == '__main__':
    ...
    print('---')
    multimodal.predictExample(bl_2_samps, bl_2_targs, metric=True)
    print("visual perfomance:")
    visual.predictExample(bl_1_samps, bl_1_targs, metric=True)
    print('---')
    visual.predictExample(bl_3_samps, bl_3_targs, metric=True)
    print("no_feed perfomance:")
    no_feed.predictExample(bl_2_samps, bl_2_targs, metric=True)
    print('---')
    no_feed.predictExample(bl_3_samps, bl_3_targs, metric=True)
